...
# 座標をずらしてから召喚
    ...
    $execute in lib:debug positioned -10 ~ -10 positioned over ocean_floor in minecraft:overworld positioned $(SpawnPosX).5 ~ $(SpawnPosZ).5 run function asset:$(ID)/summon
