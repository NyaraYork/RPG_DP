...
# IDを付与
    execute store result score @s EntityID run function common:id/value
...
# IDを2進数に変換
    ...
    scoreboard players operation #Bit32 Temp = #Bit31 Temp
    scoreboard players operation #Bit31 Temp %= #2 Const
    scoreboard players operation #Bit32 Temp -= #Bit31 Temp
    scoreboard players operation #Bit32 Temp /= #2 Const
