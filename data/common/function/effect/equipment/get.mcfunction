...
# 装備品でslotタグが指定されているエフェクトを取得
    ...
    data modify storage common: EffectsBuf append from storage common: equipment.offhand.components."minecraft:custom_data".effects[{slot:"offhand"}]
    data modify storage common: EffectsBuf append from storage common: equipment.offhand.components."minecraft:custom_data".effects[{slot:"hand"}]
    data modify storage common: EffectsBuf append from storage common: equipment.offhand.components."minecraft:custom_data".effects[{slot:"any"}]
    data modify storage common: EffectsBuf append from storage common: equipment.chest.components."minecraft:custom_data".effects[{slot:"chest"}]
    data modify storage common: EffectsBuf append from storage common: equipment.chest.components."minecraft:custom_data".effects[{slot:"armor"}]
    data modify storage common: EffectsBuf append from storage common: equipment.chest.components."minecraft:custom_data".effects[{slot:"any"}]
    data modify storage common: EffectsBuf append from storage common: equipment.legs.components."minecraft:custom_data".effects[{slot:"legs"}]
    data modify storage common: EffectsBuf append from storage common: equipment.legs.components."minecraft:custom_data".effects[{slot:"armor"}]
    data modify storage common: EffectsBuf append from storage common: equipment.legs.components."minecraft:custom_data".effects[{slot:"any"}]
    data modify storage common: EffectsBuf append from storage common: equipment.head.components."minecraft:custom_data".effects[{slot:"head"}]
    data modify storage common: EffectsBuf append from storage common: equipment.head.components."minecraft:custom_data".effects[{slot:"armor"}]
    data modify storage common: EffectsBuf append from storage common: equipment.head.components."minecraft:custom_data".effects[{slot:"any"}]
    data modify storage common: EffectsBuf append from storage common: equipment.feet.components."minecraft:custom_data".effects[{slot:"feet"}]
    data modify storage common: EffectsBuf append from storage common: equipment.feet.components."minecraft:custom_data".effects[{slot:"armor"}]
    data modify storage common: EffectsBuf append from storage common: equipment.feet.components."minecraft:custom_data".effects[{slot:"any"}]
